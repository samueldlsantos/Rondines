...
gulp.task('watch', function () {
    ...
    gulp.watch([paths.src.html.files, paths.src.partials.files], gulp.series('fileinclude'));
});
...
gulp.task('unminyfieddev', function () {
    return gulp
        .src(paths.src.js.files)
        .pipe(gulp.dest(paths.src.js.test));
});
...
gulp.task('watchdev', function () {
    gulp.watch(paths.src.scss.files, gulp.series('scssdev'));
});
...
gulp.task('default', gulp.series(gulp.parallel('clean:packageLock', 'clean:dist', 'copy:all', 'copy:libs', 'fileinclude', 'scss', 'js', 'jsPages', 'html'), gulp.parallel('watch')));
